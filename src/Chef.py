...
class Chef:
    ...
    def __init__(self, name, skill = 0, dishes):
        ...
        Arguments:
            ...
            dishesKnown (list of strings): The names of dishes that the chef can make
        """
        self.name = name
    ...
    def cookDish(dish):
        ...
        if dish in self.dishesKnown:
            ...
            raise UnkownDishException("This dish is not known by chef %s. Known dishes are: %s" % (self.name, str(self.dishesKnown))
